...
private:
    ...
    static int my_count;
    static int my_amount;

public:
    SALES(int count, int amount)
    {
        my_count = count;
        my_amount = amount;
        total_count += count;
    ...
    void sales_report(int count, int amount)
    {
        my_count += count;
        my_amount += amount;
        total_count += count;
    ...
    void print_report()
    {
        cout << total_count << endl << total_amount << endl << my_count << endl << my_amount << endl;
    }
};

int SALES::total_count = 0;
int SALES::total_amount = 0;
...
// int main()
// {
// 	cout << typeid func(10, 20).name() << endl;
// }
